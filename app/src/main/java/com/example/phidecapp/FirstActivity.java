...
public class FirstActivity extends Home {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter=new ClientAdapter(list_client);
        ...
        rv.addOnItemTouchListener(
                new RecyclerItemClickListener(context, rv ,new RecyclerItemClickListener.OnItemClickListener() {
                    @Override public void onItemClick(View view, int position) {
                        ...
                        Intent intent = new Intent(FirstActivity.this, ViewSub.class);
    ...
    private void getClientData() {
        StringRequest stringRequest=new StringRequest(Request.Method.GET, URLs.GET_CLIENT, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                try {
                    ...
                    for (int i=0; i<array.length(); i++ ){
                        ...
                        Client listClient=new Client(ob.getInt("id"),ob.getString("nomp"),ob.getString("credit"),ob.getString("credit"),ob.getString("nom_client"),ob.getString("ville"),ob.getString("phone"),ob.getString("email"),ob.getString("rc"),ob.getString("com"));
                        list_client.add(listClient);
                    }
    ...
    private void openDialog() {
        Add_client.display(getSupportFragmentManager());
    }
}
